...
triggerall = ctrl && p2stateno=3106
triggerall = enemynear, authorname != "warusaki3" && enemynear, authorname != "H”"
trigger1 = p2bodydist X>=10

[State -1]
type = null;ChangeState
value = ifelse(power>=1000&&life>500&&p2life>50,430,420)
triggerall = var(59)
triggerall = roundstate = 2&&statetype != A
triggerall = enemynear, authorname != "warusaki3" && enemynear, authorname != "H”"
trigger1 = ctrl && p2stateno=3106 && p2movetype!=A; 47 54
trigger1 = p2bodydist X<=35 && enemynear,animtime>=-2
...
value = 410
triggerall = var(59)
triggerall = roundstate = 2&&statetype != A&&p2movetype!=H
trigger1 = ctrl||((stateno=[4000,4021])&&!animtime)
trigger1 = p2bodydist X<35 && enemynear,animtime=[-6,-4)
trigger1 = random%6<2&&p2stateno<1000

[State -1,doge]
type = ChangeState
value = 830
triggerall = var(59)&&roundstate = 2&&var(20) = 6&&statetype != A
triggerall =(StateNo = [200,450]) && time <= 2
trigger1 = p2movetype=A && (time<=1||stateno>=2000)
trigger1 = random>life&&(p2stateno>=2000|| random%5<2)

[State -1, Taunt]
type = ChangeState
value = ifelse(random%5<2&&p2stateno>=5000,310,300)
triggerall = var(59)
triggerall = roundstate = 2&&statetype != A
trigger1 = StateNo = 221 && (var(36) = 1||var(36) = 2)&&random<life
...
trigger1 = p2statetype = A&&p2bodydist X<20
trigger1 = p2movetype = I&&random%6<3

[State -1]
type = ChangeState
value = 700
triggerall = var(59)
triggerall = roundstate = 2&&statetype = A&&Pos Y < -90
trigger1 = ctrl && p2statetype!=A&&p2statetype!=L&&p2bodydist X=[0,100]
trigger1 = ((random>power/3&&random<life/3&&p2movetype!=A)||(!enemynear,ctrl&&p2stateno>=200&&enemynear,time>6)||(vel X<0 && vel Y<0&&!inguarddist))&&life>500

[State -1, hadouken]
type = ChangeState
value = ifelse(p2movetype=H,1000,1050)
...
trigger1 = p2statetype=A&&p2movetype=I && p2bodydist X <100&&p2bodydist Y=[-120,-70]
trigger1 = p2bodydist X >30&&enemynear,vel Y>-2&&(random<80||(power>=2000&&random>700))
trigger2 = stateno=200||stateno=201||stateno=400||stateno=430
trigger2 = p2statetype=A&&p2movetype=I && p2bodydist X <100&&p2bodydist Y=[-120,-70]
trigger2 = p2bodydist X >30&&enemynear,vel Y>-2&&(random<100||(power>=2000&&random>600))
trigger3 = p2statetype=A&&p2movetype=I && p2bodydist X <100&&p2bodydist Y=[-120,-70]
trigger3 = p2bodydist X >30&&enemynear,vel Y>-2&&(random<100||(power>=2000&&random>500))
trigger3 = ((stateno=210||stateno=211||stateno=220||stateno=230||stateno=240||stateno=241||stateno=250||stateno=410||stateno=420||stateno=440||stateno=450||stateno=300||stateno=310)&&time<=2)
trigger4 = stateno=430&&p2stateno>=5000&&p2statetype=A&&p2bodydist Y>-40

[State -1, hadouken]
type = ChangeState
value = 1100
triggerall = var(59)&&roundstate = 2&&statetype != A&&p2statetype!=L
trigger1 = stateno<1000&&p2movetype=H && p2bodydist X <40 && p2stateno<200&&power<2000&&var(36)=2
trigger1 = animtime<-10&&random>life&&p2statetype!=A




trigger2 = stateno=430 && p2stateno>=5000&&var(36)=1&& p2bodydist X <35
trigger2 = var(5):=0||1
[State -1, hadouken]
type = null;ChangeState
value = 1200
triggerall = var(59)&&roundstate = 2&&statetype != A&&p2statetype!=L
triggerall = enemynear, authorname != "warusaki3" && enemynear, authorname != "H”"
trigger1 = StateNo = 3101 && var(5) = 1 && animelemtime(10) > 1 && p2movetype=H
trigger1 = time >=36&&p2statetype!=A


[State -1, hadouken]
type = ChangeState
value = 3000
triggerall = var(59)&&roundstate = 2&&var(20) = 6 && Power >= 1000&&statetype != A&&p2bodydist X<=100
trigger1 = stateno=1205&&p2bodydist X>10
trigger1 = p2movetype=A && power>=2000&&random>life&&random<power/3
trigger1 = var(5) := ifelse(power>=2000&&(random<50||(p2movetype=A&&p2stateno<2000)),1, ifelse(Power >= 3000&&(random>900||(p2movetype=A&&p2stateno>=2000)), 2, 0))
trigger2 = stateno=1300&&var(36)=1&&p2bodydist X<40&&p2bodydist Y>-50
trigger2 = p2life<200||(random>850&&life>500)||var(15)
trigger2 = var(5) := ifelse(power>=2000&&(random<50||(p2movetype=A&&p2stateno<2000)),1, ifelse(Power >= 3000&&(random>900||(p2movetype=A&&p2stateno>=2000)), 2, 0))
trigger3 = StateNo = 3202&&!animtime&&p2bodydist X<60
trigger3 = var(5) := ifelse(power>=2000&&(random<50||(p2movetype=A&&p2stateno<2000)),1, ifelse(Power >= 3000&&(random>900||(p2movetype=A&&p2stateno>=2000)), 2, 0))
...
value = 3100
triggerall = var(59)
triggerall = roundstate = 2&&var(20) = 6 && Power >= 1000&&statetype != A&&p2movetype=H&&p2stateno>=5000
trigger1 = (stateno=3000||stateno=3050)&&p2statetype=A&&animtime>=-4&&p2bodydist Y>=-90&&time>51&&p2statetype=A&&p2bodydist X<120
trigger1 = var(5) := ifelse(power>=2000&&(random<50||(p2movetype=A&&p2stateno<2000)),1, ifelse(Power >= 3000&&(random>950||(p2movetype=A&&p2stateno>=2000)), 2, 0))
trigger2 = (stateno=[1200,1299])&&power>=2000&&p2movetype=A
trigger2 = var(5) := ifelse(power>=2000&&(random<50||(p2movetype=A&&p2stateno<2000)),1, ifelse(Power >= 3000&&(random>950||(p2movetype=A&&p2stateno>=2000)), 2, 0))
trigger3 = stateno = 1000 && animelemtime(7)>0 && (var(28)+var(30)=var(5)+1)
trigger3 = p2bodydist X>=70 && random<power/10&&random>life&&random>p2life
trigger3 = var(5) := ifelse(power>=2000&&(random<50||(p2movetype=A&&p2stateno<2000)),1, ifelse(Power >= 3000&&(random>950||(p2movetype=A&&p2stateno>=2000)), 2, 0))
...
trigger1 = ctrl&&pos Y>-50&&vel Y>0&&p2bodydist X=[-20,10]
...
triggerall = random <= 500+500*(life/const(data.life)) || helper(11000),var(44)=1
trigger1 = enemynear,facing != facing
trigger1 = helper(11000),var(44)!=2 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = enemynear,time <= (helper(11000),var(29)-5)
...
triggerall = enemynear,time <= (helper(11000),var(29)-4)
triggerall = p2bodydist x = [0,40]
trigger1 = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = random<=450+350*(life/const(data.life))
trigger2 = enemynear, time = 1
trigger2 = enemynear, stateno < 2000
trigger2 = random<=300
...
triggerall = p2bodydist x = [0,40]
trigger1 = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = random<=500+300*(life/const(data.life))
trigger2 = enemynear, time = 1
trigger2 = enemynear, stateno < 2000
trigger2 = random<=200+200*(life/const(data.life))
...
trigger1 = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = random<=600+300*(life/const(data.life))
trigger2 = enemynear, time = 1
trigger2 = enemynear, stateno < 2000
trigger2 = random<=300+100*(life/const(data.life))
...
triggerall = !enemynear,hitdefattr = sca,aa,ap,at
triggerall = enemynear, statetype != A
trigger1 = enemynear,time <= (helper(11000),var(29)-6)
trigger1 = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = random<=600
trigger2 = enemynear, time = 1
trigger2 = enemynear, stateno < 2000
trigger2 = random <= 300+200*(life/const(data.life))
...
trigger1 = enemynear,time <= (helper(11000),var(29)-6)
trigger1 = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = random<=500+200*(life/const(data.life))
trigger2 = enemynear, time = 1
trigger2 = enemynear, stateno < 2000
trigger2 = random <= 300+100*(life/const(data.life))
...
triggerall = random <= 1000-life/1.6
...
trigger5 = var(5):=0||1
trigger5 = random <= 500-300*(life/const(data.life))
...
trigger6 = var(5):=0||1
trigger6 = random <= 500-300*(life/const(data.life))
...
triggerall = random <= 500-400*(life/const(data.life))
triggerall = (stateno != 1300 && stateno != 2800)||(animelemtime(3)>0&&!var(36))
trigger1 = ((!var(20) || var(20) = 2 || (var(20) = 6 && !var(16))) && Power >= 3000) || (var(20) = 3 && (100*life/const(data.life))<=30 && var(14)) || (var(15) && Power >= 1000) || (var(0)&2**3) 
trigger1 = (StateNo = [1000,1399]) && (var(20) = 2 || var(20) = 6) || StateNo = 1550 && (var(20) = 2 || var(20) = 6) || (StateNo = [2800,2999]) && (var(20) = 2 || var(20) = 6) || ctrl
trigger1 = ((!var(20) || var(20) = 2 || (var(20) = 6 && !var(16))) && Power >= 3000) || (var(20) = 3 && (100*life/const(data.life))<=30 && var(14)) || (var(15) && Power >= 1000) || (var(0)&2**3) 
...
trigger5 = var(5):=0||1
trigger5 = random <= 200-200*(life/const(data.life))
trigger6 = (stateno = 100 && animelemtime(2) > 1) || stateno = 101 || stateno = 40 || (stateno = 52 && anim = 57 && time >= 2) || StateNo = 200 || StateNo = 201 || stateno = 400 || stateno = 430 || time <= 2 && StateNo = [210,450]
trigger6 =  ((!var(20) || var(20) = 4 || var(20) = 6) && Power >= 1000) || (var(20) = 1 && Power >= 1500) || (var(20) = 2 && Power >= 3000) || (var(20) = 3 && (100*life/const(data.life))<=30) || (var(0)&2**3) || var(14) || var(16)
trigger6 = p2bodydist x = [0,80]
trigger6 = var(5):=0||1
trigger6 = random <= 200-200*(life/const(data.life))
...
triggerall = statetype != A
triggerall = enemynear,movetype = A
triggerall = enemynear, hitdefattr = sca, aa, ap, at || enemynear, numproj || helper(11000),var(51) || enemynear,time = [(helper(11000),var(29)-6)-1,(helper(11000),var(29)-6)]
...
triggerall = random <= 400+(1000-life)*0.6
trigger1 = ctrl
...
triggerall = statetype != A
triggerall = enemynear, movetype = A
triggerall = enemynear,animtime<=(-29-random%10) && !enemynear, ctrl
triggerall = inguarddist
triggerall = enemynear, hitdefattr = sca, aa, ap || helper(11000),var(29) || enemynear, numproj || helper(11000),var(51)
triggerall = var(20) = 0 || var(20) = 1 || var(20) = 4 || var(20) = 6
triggerall = ctrl || (stateno = 100 && animelemtime(2) > 1) || stateno = 101 || time <= 2 && StateNo = [200,450]
triggerall = enemynear,facing != facing
...
triggerall = enemynear,movetype = A
triggerall = ctrl || (stateno = 100 && animelemtime(2) > 1) || stateno = 101
triggerall = var(20)<2 || var(0):=(var(0)-(var(0)&2**5))+2**5||(enemynear,numproj&&!ctrl)
triggerall = enemynear,facing != facing
...
trigger3 = enemynear,numproj&&!ctrl
[State AI, Dodge]
type = changestate
value = 830
triggerall = var(59)
...
trigger1 = p2bodydist x - abs(helper(11000),fvar(23))*(1-helper(11000),fvar(22)**5)/(1-helper(11000),fvar(22)) <= 30
...
triggerall = ctrl
triggerall = enemynear,movetype = H && !enemynear,ctrl
trigger1 = p2bodydist x - helper(11000),fvar(23)*(1-helper(11000),fvar(22)**3)/(1-helper(11000),fvar(22)) <= 28
...
triggerall = enemynear, statetype = S
triggerall = StateNo = 430 || stateno = 410 || stateno = 201 || stateno = 211 || stateno = 241 || stateno = 400
trigger1 = p2bodydist x + abs(helper(11000),fvar(23))*(1-helper(11000),fvar(22)**9)/(1-helper(11000),fvar(22)) <= 16+ifelse(enemynear,backedgedist <= 30, 20, 0)
trigger1 = EnemyNear,GetHitVar(hittime)>=7
trigger1 = var(5) := 2
trigger2 = p2bodydist x + abs(helper(11000),fvar(23))*(1-helper(11000),fvar(22)**7)/(1-helper(11000),fvar(22)) <= 16+ifelse(enemynear,backedgedist <= 30, 20, 0)
trigger2 = EnemyNear,GetHitVar(hittime)>=5
trigger2 = var(5) := 1
trigger3 = p2bodydist x + abs(helper(11000),fvar(23))*(1-helper(11000),fvar(22)**5)/(1-helper(11000),fvar(22)) <= 16+ifelse(enemynear,backedgedist <= 30, 20, 0)
...
[State AI, merry-go-round cancel]
type = changestate
value = 1200
triggerall = var(59)
triggerall = roundstate = 2
...
triggerall = StateNo = 430 || stateno = 410 || stateno = 201 || stateno = 211 || stateno = 241
triggerall = enemynear, statetype != A
trigger1 = p2bodydist x + enemynear,vel x*(1-helper(11000),fvar(22)**12)/(1-helper(11000),fvar(22)) <= 90
...
trigger1 = (p2bodydist x +abs(helper(11000),fvar(23))*(1-helper(11000),fvar(22)**(3))/(1-helper(11000),fvar(22))) <= 28
Trigger1 = EnemyNear,GetHitVar(hittime)>= 1
...
triggerall = P2stateno != 5120
triggerall = P2stateno != 5201
triggerall = power >= 2000-1000*ifelse(var(15),0,1)
trigger1 = enemynear, hitdefattr != SCA
trigger1 = p2movetype = A && (!inguarddist||prevstateno=800||prevstateno=810)
trigger2 = p2movetype = A
trigger2 = enemynear,facing=facing
...
;triggerall = !inguarddist || enemynear,time <= (helper(11000),var(29)-5) || enemynear, hitdefattr = SCA,AT
;triggerall = enemynear, animtime < -5
triggerall = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
...
[State AI, Raijin anti-air start]
type = changestate
value = 1050
triggerall = var(59)
triggerall = roundstate = 2
triggerall = statetype != A
triggerall = p2bodydist x - 7*enemynear, vel x = [0,50]
triggerall = enemynear,pos y+7*enemynear, vel y+24.5*enemynear,const(movement.yaccel) = [-90,-20]
triggerall = 1;enemynear, vel y <= 0
triggerall = enemynear,statetype = A
triggerall = enemynear,stateno != 5120 && enemynear,stateno != 5201
...
triggerall = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = ctrl || (stateno = 100 && animelemtime(2) > 1) || stateno = 101
trigger1 = random <= 400-300*helper(11000),var(46)
trigger1 = var(5):=2
...
triggerall = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = ctrl || (stateno = 100 && animelemtime(2) > 1) || stateno = 101
trigger1 = random <= 800-600*helper(11000),var(46)
...
triggerall = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = ctrl || (stateno = 100 && animelemtime(2) > 1) || stateno = 101
;trigger1 = random <= 300+200*(life/const(data.life))
...
triggerall = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = ctrl || (stateno = 100 && animelemtime(2) > 1) || stateno = 101
trigger1 = random <= 100+100*(life/const(data.life))
...
triggerall = helper(11000),var(44)!=1 && helper(11000),var(44)!=4 && enemynear, time >= 2
trigger1 = ctrl || (stateno = 100 && animelemtime(2) > 1) || stateno = 101
trigger1 = random <= 50*((1000-life)/const(data.life))
